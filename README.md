...
| [`brandon-git`](./skills/brandon-git) | Git writing conventions — imperative commit messages, PR titles, commit-derived changelog entries, and commit suggestions. |
...
└── skills/
    ...
    ├── brandon-git/
    │   └── SKILL.md          # Imperative Git commit and PR writing conventions
